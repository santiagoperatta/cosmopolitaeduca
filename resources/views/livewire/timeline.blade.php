<div class="mt-16 w-full max-w-5xl mx-auto p-4">
	<h1 class="text-center font-bold text-4xl text-gray-700 leading-tight">¿Por qué elegir Cosmopolita Educa?</h1>
	...
	<div class="mx-auto my-12 relative">
		...
		<div class="flex flex-col sm:flex-row justify-between items-center">
			...
			<div class="flex flex-col items-center relative">
				...
				<h3 class="my-2 text-lg font-semibold ">Flexibilidad de Horarios</h3>
			...
			<div class="flex flex-col items-center relative mt-4 sm:mt-0">
				...
				<h3 class="my-2 text-lg font-semibold ">Contenido Actualizado</h3>
			...
			<div class="flex flex-col items-center relative mt-4 sm:mt-0">
				...
				<h3 class="my-2 text-lg font-semibold ">Profesionales Capacitados</h3>
				<p class="mx-4 mt-2 text-center text-base text-gray-500">Equipo de profesionales comprometidos contigo. Transforma tu futuro con educación de calidad.</p>
			</div>
		</div>
	</div>
</div>