                ...
                @auth
                    @can('create', App\Models\Carrera::class)
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <x-nav-link :href="route('carreras.create')" :active="request()->routeIs('carreras.create')">
                                {{ __('Crear Carrera') }}
                            </x-nav-link>
                        </div>
                    @endcan
        ...
        @auth
            @if (auth()->user()->rol === 2)
				...
				<div class="pt-2 pb-3 space-y-1">
					...
					<x-responsive-nav-link :href="route('carreras.create')" :active="request()->routeIs('carreras.create')">
						{{ __('Crear Carrera') }}
					</x-responsive-nav-link>
				</div>
            @endif
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
						...
						@cannot('create', App\Models\Carrera::class)
							...
							<x-responsive-nav-link :href="route('cursosv.index')" :active="request()->routeIs('cursosv.index')">
								{{ __('Cursos') }}
							</x-responsive-nav-link>
